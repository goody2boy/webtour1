...
item.about = function(id) {
    ajax({
        service: '/item/get',
        data: {id: id},
        done: function(resp) {
            if (resp.success) {
                popup.open('popup-edit', 'About', Fly.template('/item/about.tpl', resp), [
                    {
                        title: 'Cập nhật',
                        style: 'btn-success',
                        fn: function() {
...
item.property = function(id) {
    ajax({
        service: '/item/get',
        data: {id: id},
        done: function(resp) {
            if (resp.success) {
                popup.open('popup-edit', 'Thuộc tính', Fly.template('/item/property.tpl', resp), [
                    {
                        title: 'Cập nhật',
                        style: 'btn-success',
                        fn: function() {
...
item.changePosition = function(id) {
