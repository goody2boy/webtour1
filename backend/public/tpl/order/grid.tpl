            ...
            <form method="GET" action="#order/grid" id="search" class="form row" >
                ...
                <div class="col-sm-3 padding-all-5">
                    ...
                    <div class="form-group" style="margin-top:5px;">
                        <input type="number" class="form-control" name="total_priceFrom" placeholder="Giá từ">
                    </div>
                </div><!-- /col -->
                ...
                <div class="col-sm-3 padding-all-5">
                    ...
                    <div class="form-group" style="margin-top:5px;">
                        <input name="total_priceTo" type="number" class="form-control" placeholder="Giá đến">
                    </div>
