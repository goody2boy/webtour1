            ...
            <form method="GET" action="#money/grid" id="search" class="form row" >
                <div class="col-sm-3 padding-all-5">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                        <input type="hidden" name="create_time" data-search="create_time" class="form-control" placeholder="CreateTime">
                ...
                <div class="col-sm-3 padding-all-5">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                        <input type="hidden" name="create_time_to" data-search="create_time_to"  class="form-control" placeholder="CreateTimeTo">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
                </div><!-- /col -->
                <div class="col-sm-3 padding-all-5">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                        <input type="hidden" name="update_time" data-search="update_time"  class="form-control" placeholder="UpdateTime">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
                ...
                <div class="col-sm-3 padding-left-5">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                        <input type="hidden" name="update_time_to" data-search="update_time_to"  class="form-control" placeholder="UpdateTimeTo">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
            ...
            <table id="mytable" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr class="success" >
                        ...
                        <th class="text-center" style="vertical-align: middle;width: 100px;" >Ngôn ngữ<i class="glyphicon glyphicon-edit pull-right"></i></th>
